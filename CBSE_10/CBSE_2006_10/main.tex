...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.5\columnwidth,center]{./fig/fig1.1.png}
	\caption{}
	\label{fig1}
 \end{figure}
\vspace{2mm}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.5\columnwidth,center]{./fig/fig1.2.png}
	\caption{}
	\label{fig2}
 \end{figure}
\end{enumerate}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.5\columnwidth,center]{./fig/fig1.3.png}
	\caption{}
	\label{fig3}
 \end{figure}
\item \begin{enumerate}
